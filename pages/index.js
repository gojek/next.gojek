...
function HomePage(props) {
  ...
  return (
    <div className="text-center text-md-left">
      <Navbar light bg="#ffa000" />

      {/* banner section */}
      <section
        id="banner"
        className="bg-orange-lightest full-height py-5 d-flex align-items-center "
      >
      ...
      {/* products section */}
      <section id="products" className="full-height d-flex align-items-center py-5 transport">
      ...
      {/* vision section */}
      <section id="vision" className="full-height d-flex align-items-center">
      ...
      {/* scale section */}
      <section id="scale" className="bg-green-light full-height d-flex align-items-center">
        <div className="container">
          <div className="row">
      ...
      {/* open source section */}
      <section id="open-source" className="full-height d-flex align-items-center py-5">
        <div className="container text-center pt-5">
      ...
      <section id="social-impact" className="bg-pink full-height d-flex align-items-center py-5">
        <div className="container text-white">
          <div className="row">
            <div className="col-lg-5 pr-5">
              ...
              <p>
                The average Gojek driver partner is able to generate revenue of xxx, while merchants
                who sign up for GoFood have reported order volumes increasing by as much as 345%.
              </p>
              <p>
