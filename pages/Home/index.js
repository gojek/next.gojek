...
import IntersectionView from '../../comps/components/IntersectionView'
  ...
  const contentData = [
    {
      ...
      navColor: "#ffa000",
      isNavColorChange: true
    },
    {
      section: renderProduct,
      navColor: "#fff",
      isNavColorChange: false
    },
    {
      section: renderVision,
      navColor: "#fff",
      isNavColorChange: false
    },
    {
    ...
    {
      section: renderFunding,
      navColor: "#fff",
      isNavColorChange: false
    },
    {
      section: renderOpenSource,
      navColor: "#fff",
      isNavColorChange: false
    },
    {
      section: renderSocialImpect,
      navColor: "#d0006f",
      isNavColorChange: true
    },
  ]
  ...
  return (
    <div className="text-center text-md-left">
      ...
      {contentData.map(data => {
        const { section, navColor, isNavColorChange } = data
        return <IntersectionView
          onScroll={(entry) => changeBg(navColor, isNavColorChange, entry)}>
          {section()}
        </IntersectionView>
      })}
